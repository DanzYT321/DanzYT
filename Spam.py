...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print (" Subrek Danz YT  Slurr, Gk Subrek Gk Kawan")
    time.sleep(1)
    os.system("xdg-open https://youtube.com/channel/UCyOb9Jo3https://youtube.com/channel/UCLbqZ376ZiEdDkMjYPZKKFQA0ZtUx_DcD4W2pQ")
    time.sleep(5)
    os.system("clear")
...
def banner_anjay_subs_mr_dark():
    ...
    print ("   ╚═╝┴  ┴ ┴┴ ┴     ╚═╝└─┘└┴┘")
    print ("")
    print ("    > Author  : Cyber Danz ")
    print ("    > YouTube : Danz YT ")
    print ("    > Github  : github.com/DanzYT321 ")
    print ("")
